...
frame:SetScript("OnEvent", function(self, event, addon)
	if( event == "PLAYER_LOGIN" ) then
		...
		loaded = true
		print('testing login', event, addon)
		self:UnregisterEvent("PLAYER_LOGIN")
	elseif( event == "ADDON_LOADED" and (addon == "ShadowedUnitFrames") ) then -- I added this case.
		print(event, addon, "nameplate distance login:", GetCVar("nameplateMaxDistance"))
		SetCVar("nameplateMaxDistance", 41) -- Added by me
		print("nameplate distance after:", GetCVar("nameplateMaxDistance"))
	elseif( event == "ADDON_LOADED" and ( addon == "Blizzard_ArenaUI" or addon == "Blizzard_CompactRaidFrames" ) and loaded ) then
		print('testing loaded', event, addon)
